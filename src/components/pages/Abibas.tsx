...
import abibasModel1 from "../../assets/abibas/abiba1.jpg";
import abibasModel2 from "../../assets/abibas/abiba3.jpg";
import abibasModel3
    from "../../assets/abibas/abiba4.jpg";
import {adidasArr, AdidasItem} from "./Adidas";
import {Link} from "react-router-dom";
export const abibasArr: AdidasItem[] = [
    {
        id:1,
    ...
    {
        id:3,
        model: 'ABIBAS ABIFOM SUPrime Classic',
        ...
        <div>
            ...
            <div style={{display: 'flex', justifyContent: 'center'}}>
                {abibasArr.map((abibas, index) => (
                    <Link key={abibas.id} to={`/abibas/${abibas.id}`}>
                        <img
                            src={abibas.picture}
                            alt={abibas.model}
